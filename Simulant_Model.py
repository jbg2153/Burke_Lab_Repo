...
def uncert_sens(
    ...
    import shockTube_constant_volume as shock_cv
    import shockTube_constant_pressure as shock_cp
    ...
    if reactorType == 'cv':
        output = shock_cv.ShockTube(ctiFile,speciesNames,pressure,temperature,
                                 concentrations,initialTime,finalTime,thermalBoundary,
                                 observables,physicalParams, kinetic_sens,
                                 physical_sens,reactorType)
    elif reactorType == 'cp':
        output = shock_cp.ShockTube(ctiFile,speciesNames,pressure,temperature,
                                 concentrations,initialTime,finalTime,thermalBoundary,
                                 observables,physicalParams, kinetic_sens,
                                 physical_sens,reactorType)
